...
const testimonials = [
 {
  ...
  content: 'Investi helped us connect with the right investors and close our Series A in just 3 months.',
  rating: 5,
  avatar: 'SC'
 },
 {
  ...
  company: 'Seed - $2.5M',
  content: 'The AI matching was incredible. Every investor we met was genuinely interested in our space.',
  rating: 5,
  avatar: 'MR'
 },
 {
  ...
  content: 'From cold outreach to warm introductions, Investi transformed our fundraising process.',
  rating: 5,
  avatar: 'EW'
 },
 {
  ...
  role: 'CEO, FinanceAI',
  company: 'Series A - $8M',
  content: 'The analytics dashboard gave us insights we never had before. Game-changing platform.',
  rating: 5,
  avatar: 'DK'
 },
 {
  ...
  company: 'Seed - $1.8M',
  content: 'Raised our seed round 40% faster than expected. The investor network is unmatched.',
  rating: 5,
  avatar: 'LT'
 },
 {
  ...
  content: 'Investi\'s personalized outreach templates had a 45% response rate. Incredible results.',
  rating: 5,
  avatar: 'AJ'
 }
]
...
const premiumFeatures = [
 {
  ...
  description: 'Reach out to up to 5 investors per day directly via Investi, and fill your funding pipeline.',
  highlight: false
 },
 {
  icon: Filter,
  title: '10 investor filters',
  description: 'Target the right investors with exclusive filters: check size, lead preferences, etc.',
  highlight: false
 },
 {
  icon: Search,
  title: 'Intro finder',
  description: 'Plug in your email. Investi scans your network and finds who can make an intro to your dream investor.',
  highlight: true
 },
 {
  icon: DollarSign,
  title: '$2,000,000 discount',
  description: 'Get massive discount on Airtable, Stripe, Hubspot, Azure and many exclusive deals.',
  highlight: false
 },
 {
  icon: BookOpen,
  title: 'Fundraising masterclass',
  description: 'Learn how to raise like a pro: 24 videos of 10 min each to guide you from zero to funded.',
  highlight: false
 },
 {
  icon: BarChart3,
  title: 'Unlimited deck reviews',
  description: 'Get actionable feedback on your pitch deck, as often as you need, until it\'s perfect.',
  highlight: false
 },
 {
  icon: FileText,
  title: 'Pitch deck template',
  description: 'Build a top 1% pitch deck with our battle-tested template. Works on PowerPoint & Google Slides.',
  highlight: false
 },
 {
  icon: Headphones,
  title: 'Support Investi',
  description: 'Your membership helps us make venture capital a better, more open industry.',
  highlight: false
 }
]
   ...
   <div className='max-w-7xl mx-auto relative z-10'>
    <div className='text-center mb-12 sm:mb-16 lg:mb-20'>
     ...
     <p className='text-lg sm:text-xl text-zinc-300 max-w-4xl mx-auto leading-relaxed font-medium'>
      ...
      you need to successfully fund your startup and scale your business.
     </p>
    </div>

    {/* Main Features Grid */}
    <div ref={gridRef} className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20'>
    ...
    <div className='mb-16 sm:mb-20'>
       ...
       <div className='flex flex-col lg:flex-row items-center gap-8 lg:gap-12'>
        ...
        <div className='flex-shrink-0 w-48 h-48 lg:w-64 lg:h-64 bg-gradient-to-br from-primary-600/20 to-secondary-600/20 border border-primary-500/20 rounded-3xl flex items-center justify-center relative overflow-hidden'>
         ...
         <div className='relative z-10 text-center'>
          ...
          <div className='text-zinc-200 text-sm font-medium'>Investi Platform</div>
         </div>
        </div>
     ...
     <div className='text-center mb-12'>
      <h3 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-zinc-100 mb-4'>
       Raise <span className='text-primary'>10x</span> Faster With Premium
      </h3>
      <p className='text-zinc-300 text-lg mb-2'>
       Investi Premium Gives You Advanced Features To Raise Better And Faster.
      </p>
      <p className='text-zinc-400 mb-8'>
       Upgrade for <span className='text-primary font-semibold'>$99/month</span> or just{' '}
       <span className='text-primary font-semibold'>$299/year</span>.
      </p>
     </div>
      ...
      {premiumFeatures.map((feature, index) => (
       ...
       >
        <CardContent className='p-6 sm:p-8'>
         <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 ${feature.highlight
          ? 'gradient-primary shadow-lg'
          : 'bg-gradient-to-br from-zinc-700 to-zinc-800'
          }`}>
          <feature.icon className={`h-6 w-6 ${feature.highlight ? 'text-white' : 'text-zinc-300'}`} />
         </div>
    ...
    <div className='relative'>
     ...
     <div className='relative text-center bg-gradient-to-r from-zinc-900/80 to-zinc-950/80 backdrop-blur-sm border border-zinc-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12'>
      ...
      <p className='text-zinc-300 mb-8 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed'>
       ...
       Start your free trial today and connect with the right investors tomorrow.
      </p>
