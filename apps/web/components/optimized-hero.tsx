...
export function OptimizedHero() {
 ...
 return (
  <section
   ref={heroRef}
   className='relative pt-24 pb-12 px-4 sm:px-6 lg:px-8 min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950/20 to-slate-950'
  >
   {/* Optimized Background */}
   <div className='absolute inset-0'>
    <div className='floating-bg absolute top-20 left-10 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl'></div>
    <div className='floating-bg absolute bottom-20 right-10 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl'></div>
   ...
   <div className='container mx-auto text-center relative z-10'>
    ...
    >
     ...
     <span className='bg-gradient-to-r from-blue-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent bg-300% animate-gradient'>
      6,034 investors
     </span>
    ...
    >
     <Button
      size='lg'
      className='group text-lg px-8 py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105'
     >
    ...
    <div ref={searchRef} className='max-w-4xl mx-auto mb-12'>
     <div className='bg-slate-900/60 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 shadow-2xl hover:shadow-blue-500/10 transition-all duration-300'>
      <div className='flex flex-col md:flex-row gap-4 items-center'>
       <div className='flex items-center gap-4 flex-1 flex-wrap justify-center md:justify-start'>
        <div className='flex items-center gap-2 px-3 py-2 bg-slate-800/50 rounded-lg'>
         ...
         <span className='text-sm text-blue-400'>Series A</span>
        </div>
        <div className='flex items-center gap-2 px-3 py-2 bg-slate-800/50 rounded-lg'>
         <span className='text-sm text-slate-400'>Industry:</span>
         <span className='text-sm text-green-400'>FinTech</span>
        </div>
        <div className='flex items-center gap-2 px-3 py-2 bg-slate-800/50 rounded-lg'>
         <span className='text-sm text-slate-400'>Location:</span>
         <span className='text-sm text-purple-400'>Global</span>
        </div>
       </div>
       <Button className='bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-8 text-white hover:scale-105 transition-all duration-300'>
