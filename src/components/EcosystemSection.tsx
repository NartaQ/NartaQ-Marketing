...
export default function EcosystemSection() {
  return (
    <section className="flex w-full flex-col items-center justify-center p-[2%] py-32 relative">
      ...
      <div className="max-w-6xl mx-auto text-center space-y-8 relative z-10">
        ...
        <div className="space-y-6 reveal-up">
          ...
          <h2 className="text-4xl md:text-5xl font-light text-[#dcd7ce]">
            An <span className="font-medium text-[#a98b5d] ">innovative ecosystem</span>
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16 max-w-7xl w-full px-4 reveal-up">
          ...
          <div className="premium-glass elite-hover rounded-3xl p-10 border border-[#a98b5d]/20  h-full">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#dcd7ce] font-medium">AI-powered rubric analysis</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#a98b5d]"></div>
                <span className="text-[#dcd7ce] font-medium">Curated investor outreach</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#a98b5d]"></div>
                <span className="text-[#dcd7ce] font-medium">Progress tracking & follow-ups</span>
              </div>
            </div>
        ...
        <Link href="/companies-providers" className="group relative">
          <div className="premium-glass elite-hover rounded-3xl p-10 border border-[#a98b5d]/20  h-full">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#a98b5d]"></div>
                <span className="text-[#dcd7ce] font-medium">Private bounties with curated matching</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#a98b5d]"></div>
                <span className="text-[#dcd7ce] font-medium">Milestone releases & escrow protection</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#a98b5d]"></div>
                <span className="text-[#dcd7ce] font-medium">Hybrid compensation (cash + equity)</span>
              </div>
            </div>
