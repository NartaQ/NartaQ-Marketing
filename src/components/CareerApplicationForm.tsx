            ...
            >
              ...
              <div className='text-center mb-12'>
                ...
                <p className='font-serif text-lg text-gray-300 max-w-2xl mx-auto'>
                  Ready to make an impact? Tell us about yourself and let's
            ...
            >
              <div className='max-w-2xl mx-auto'>
                ...
                <p className='font-serif text-xl text-gray-300 mb-8 leading-relaxed'>
                  Thank you for your interest in joining NartaQ. Our team will
                  review your application and get back to you within 5-7
                  business days.
                </p>
