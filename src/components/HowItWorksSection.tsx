  ...
  const steps = [
    {
      ...
      description: 'Create your verified profile with identity confirmation and investment preferences. Our team will personally learn your criteria and preferences to prepare for AI-powered learning.'
    },
    {
      id: 2,
      icon: Brain,
      title: 'Intelligent Matching',
      description: 'Our AI engine analyzes multiple data points to identify high-potential matches, providing personalized deal recommendations based on compatibility and success patterns.'
    },
    {
      id: 3,
      icon: Handshake,
      title: 'Secure Discussion',
      description: 'Enter a protected environment with conversation templates and market guidance. AI assists with standard terms and deal structure recommendations.'
    },
    {
      id: 4,
      icon: FileSignature,
      title: 'Automated Documentation',
      description: 'Streamlined deal closure generates all necessary legal documentation, manages signatures, and handles regulatory requirements.'
    },
    {
      id: 5,
      icon: Banknote,
      title: 'Transparent Fund Transfer',
      description: 'Funds are held securely with automated release based on agreed milestones. Smart contracts ensure transparent and efficient capital deployment.'
    }
  ]
