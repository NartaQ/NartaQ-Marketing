...
export default function CoreToolsShowcase() {
  ...
  const tools = [
    {
      ...
      startups: {
        ...
        description: 'Our AI analyzes your startup profile and matches you with investors who have funded similar companies in your stage and sector.',
        features: ['Smart investor scoring', 'Automated outreach', 'Response tracking']
      },
      investors: {
        title: 'Deal flow filtering by stage/geo/traction',
        description: 'Advanced filters help you find deals that match your investment thesis, with real-time traction metrics and geographic preferences.',
        features: ['Thesis-based matching', 'Real-time filtering', 'Quality scoring']
      },
      providers: {
        title: 'Client matching by specialization',
        description: 'Get matched with startups that need your specific expertise, based on their current challenges and growth stage.',
        features: ['Skill-based matching', 'Project recommendations', 'Demand forecasting']
      }
    },
    {
      name: 'Valuation Lab',
      ...
      startups: {
        ...
        description: 'Model different funding scenarios and see how they impact your ownership and dilution across multiple rounds.',
        features: ['Cap table modeling', 'Dilution analysis', 'Scenario planning']
      },
      investors: {
        title: 'Portfolio monitoring + benchmarking',
        description: 'Track portfolio company performance against industry benchmarks and identify opportunities for additional investment.',
        features: ['Performance tracking', 'Benchmark analysis', 'Risk assessment']
      },
      providers: {
        title: 'Service pricing optimizer',
        description: 'Optimize your service pricing based on market rates, client budgets, and value delivered to maximize revenue.',
        features: ['Market rate analysis', 'Value-based pricing', 'Revenue optimization']
      }
    },
    {
      name: 'Market Intel',
      ...
      startups: {
        ...
        description: 'Stay informed about competitor funding rounds, investor preferences, and market trends in your sector.',
        features: ['Funding intelligence', 'Competitor analysis', 'Market trends']
      },
      investors: {
        title: 'Sector deep dives + trend forecasts',
        description: 'Access comprehensive sector analysis with trend forecasts to inform your investment strategy and thesis development.',
        features: ['Sector analysis', 'Trend forecasting', 'Investment insights']
      },
      providers: {
        title: 'Demand heatmaps for services',
        description: 'Visualize demand patterns for different services across sectors and geographies to optimize your service offerings.',
  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-black via-[#232428] to-[#3e3f44]">
      ...
      <div className="absolute inset-0 luxury-texture opacity-20" />
      <div className="absolute top-1/4 right-0 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-[#a98b5d]/3 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 left-0 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-[#5c5d63]/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 space-y-3 sm:space-y-4">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-[#232428]/80 border border-[#a98b5d]/20 backdrop-blur-sm">
            ...
            <span className="text-xs sm:text-sm font-medium text-[#a98b5d]">CORE TOOLS</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-[#dcd7ce] px-4">
            <span className="text-[#a98b5d] font-semibold">Powerful Tools</span> for Every User
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div className="inline-flex p-1 sm:p-1.5 rounded-xl sm:rounded-2xl bg-[#1a1b1f]/90 border border-[#a98b5d]/30 backdrop-blur-sm shadow-lg w-full max-w-md sm:max-w-none sm:w-auto">
                <TabsList className="grid grid-cols-3 bg-transparent p-0 h-auto gap-1 sm:gap-2 w-full">
                  ...
                  >
                    ...
                    <span className="relative z-10 hidden xs:inline sm:inline">Startups</span>
                  ...
                  >
                    ...
                    <span className="relative z-10 hidden xs:inline sm:inline">Investors</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-[#a98b5d]/0 via-[#a98b5d]/5 to-[#a98b5d]/0 opacity-0 data-[state=active]:opacity-100 transition-opacity duration-300" />
                  </TabsTrigger>
                  <TabsTrigger
                    value="providers"
                  ...
                  >
                    ...
                    <span className="relative z-10 hidden xs:inline sm:inline">Providers</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-[#a98b5d]/0 via-[#a98b5d]/5 to-[#a98b5d]/0 opacity-0 data-[state=active]:opacity-100 transition-opacity duration-300" />
                  </TabsTrigger>
                </TabsList>
              </div>
            ...
            {['startups', 'investors', 'providers'].map((tabValue) => (
              <TabsContent key={tabValue} value={tabValue} className="space-y-6 sm:space-y-8 px-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 auto-rows-fr">
                  {tools.map((tool, index) => {
                    ...
                    return (
                      <Card key={index} className="group hover:shadow-xl hover:shadow-[#a98b5d]/10 hover:-translate-y-1 transition-all duration-300 border-[#a98b5d]/20 bg-[#232428]/60 backdrop-blur-sm hover:border-[#a98b5d]/40 flex flex-col h-full">
                        ...
                        <CardContent className="space-y-3 sm:space-y-4 flex-grow flex flex-col">
                          ...
                          <div className="space-y-1.5 sm:space-y-2 flex-grow">
                            {toolData.features.map((feature: string, featureIndex: number) => (
                              <div key={featureIndex} className="flex items-center gap-2">
                                ...
                                <span className="text-xs sm:text-sm text-[#dcd7ce] leading-relaxed">{feature}</span>
                              </div>
                            ))}
                          </div>
                          ...
                          >
                            <span className="hidden sm:inline">Explore {tool.name}</span>
                  ...
                  <Card className="max-w-2xl mx-auto border-[#a98b5d]/20 bg-[#232428]/50 backdrop-blur-sm">
                    <CardContent className="p-4 sm:p-6 lg:p-8 text-center space-y-3 sm:space-y-4">
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-[#dcd7ce] leading-tight">
                        {tabValue === 'startups' && 'Ready to accelerate your fundraising?'}
                        {tabValue === 'investors' && 'Ready to discover better deals?'}
                        {tabValue === 'providers' && 'Ready to grow your practice?'}
                      </h3>
                      <p className="text-sm sm:text-base text-[#5c5d63] max-w-xl mx-auto leading-relaxed">
                        {tabValue === 'startups' && 'Join thousands of startups who\'ve raised faster with our platform'}
                        {tabValue === 'investors' && 'Access curated deal flow that matches your investment thesis'}
                        {tabValue === 'providers' && 'Connect with funded startups that need your expertise'}
                      </p>
                      <Button
                        size="lg"
