        ...
        <div className="text-center space-y-12 max-w-5xl mx-auto">
          ...
          <div className="cta-element space-y-6">
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full premium-glass border border-[#a98b5d]/30">
              ...
              <span className="text-[#a98b5d] font-medium">WHERE GROWTH PARTNERSHIPS BEGIN</span>
            </div>

            <h2 className="text-5xl md:text-7xl font-light text-[#dcd7ce] leading-tight">
              Ready to <span className="text-[#a98b5d] font-medium">Transform</span>
              <br className="hidden md:block" />
              Your Growth Journey?
            </h2>

            <p className="text-xl md:text-2xl text-[#5c5d63] max-w-3xl mx-auto leading-relaxed">
              Join <span className="text-[#a98b5d] font-semibold">startups</span>,
              <span className="text-[#a98b5d] font-semibold"> investors</span>, and
              <span className="text-[#a98b5d] font-semibold"> service providers</span> who are building the future together
            </p>
          </div>
          ...
          <div className="cta-element space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-[#5c5d63]">
                Not ready to join? Get exclusive insights first.
              </p>
              <a
