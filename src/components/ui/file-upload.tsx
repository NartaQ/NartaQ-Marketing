      ...
      >
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <p className='relative z-20 font-sans font-normal text-neutral-500 dark:text-neutral-500 text-sm mt-1'>
            PDF, Word (.doc/.docx), PowerPoint (.ppt/.pptx) - Max 10MB
          </p>
          <div className='relative w-full mt-10 max-w-xl mx-auto'>
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  key={'file' + idx}
                  layoutId={idx === 0 ? 'cv-upload' : 'cv-upload-' + idx}
                  className={cn(
            ...
            {!files.length && (
              <motion.div
                ...
                className='absolute opacity-0 border border-dashed border-[#a98b5d] inset-0 z-30 bg-transparent flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md'
              ></motion.div>
            )}
          </div>
        </div>
