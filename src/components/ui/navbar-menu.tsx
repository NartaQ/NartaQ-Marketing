...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className='relative rounded-full border border-transparent dark:bg-[#232428] dark:border-[#5c5d63]/30 bg-[#dcd7ce] shadow-input flex justify-center space-x-4 px-8 py-6 '
    >
      {children}
    </nav>
  )
