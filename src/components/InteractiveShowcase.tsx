  ...
  const features = [
    {
      ...
      description:
        'Our network of investors and ecosystem partners actively refers and scouts deals, earning rewards for quality submissions.',
      visual: {
        type: 'neural-network',
        color: '#a98b5d',
      },
    },
    {
      ...
      description:
        'AI screens for fit, then our expert reviewer network (including active VCs) provides structured, actionable feedback.',
      visual: {
        type: 'radar',
        color: '#dcd7ce',
      },
    },
    {
      ...
      description:
        'Every startup is verified. Key data—from cap tables to technical audits—is attested on-chain for immutable due diligence.',
      visual: {
        type: 'shield',
        color: '#5c5d63',
      },
    },
    {
      ...
      description:
        'Token holders govern the platform, vote on key features, participate in due diligence, and share in the platform&apos;s success.',
      visual: {
        type: 'lightning',
        color: '#a98b5d',
      },
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-12'>
            <div className='text-center'>
              ...
              <p className='text-gray-400 text-sm'>
                Endless unvetted decks, cold outreach, and fragmented networks.
              </p>
            </div>
            <div className='text-center'>
              <div className='text-red-400 font-semibold mb-2'>
              ...
              <p className='text-gray-400 text-sm'>
                Difficult to verify teams, traction, and technical capability
                remotely.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-gray-400 text-sm'>
                The best deals are hidden within private networks and
                accelerators.
              </p>
            </div>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className='flex items-start gap-4'>
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r transition-all duration-300 p-0.5 ${
                      activeFeature === index
