  ...
  const marketInsights = [
    {
      statistic: "73%",
      description:
        "of startups struggle to find the right investors due to lack of proper connections and networking.",
    ...
    },
    {
      statistic: "6 months",
      description:
        "is the average time startups spend fundraising, often reaching out to 100+ investors.",
      source: "CB Insights",
    ...
    },
    {
      statistic: "90%",
      description:
    "of investors say they miss good opportunities because they can&apos;t efficiently discover quality startups.",
    ...
    },
    {
      statistic: "$3.2T",
      description:
        "in global venture capital is available, but only 2% of startups successfully raise funding.",
    ...
    },
    {
      statistic: "85%",
      description:
        "of successful funding rounds happen through warm introductions and proper matching.",
    ...
    },
    {
      statistic: "40%",
      description:
    "of investor time is wasted on deals that don&apos;t match their investment criteria.",
      ...
      <div className="w-full space-y-8 overflow-hidden">
        ...
        <Marquee reverse pauseOnHover className="[--duration:40s]">
          {secondRow.map((insight, index) => (
            <InsightCard key={`second-${index}`} insight={insight} />
          ))}
        </Marquee>
      </div>
