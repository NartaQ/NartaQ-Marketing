  ...
  const cardData = [
    {
      ...
      stats: { value: 'TBD', label: 'Success Goal' },
    ...
    },
    {
      ...
      features: [
        'Vetted talent marketplace launching soon',
        'Advanced skill-based matching algorithm',
        'Integrated project management tools',
        'Secure escrow payment system',
      ],
      stats: { value: 'Coming Soon', label: 'Talent Network' },
    ...
    },
    {
      ...
      stats: { value: 'Coming Soon', label: 'Expert Network' },
