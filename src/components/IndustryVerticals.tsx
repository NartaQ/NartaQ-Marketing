...
export default function IndustryVerticals() {
 ...
 const verticals = [
  { name: 'Healthtech', icon: Heart, emoji: '🏥', color: '#e74c3c', deals: '2.1K+' },
  { name: 'Deeptech', icon: Rocket, emoji: '🚀', color: '#3498db', deals: '1.8K+' },
  { name: 'Fintech', icon: CreditCard, emoji: '💳', color: '#f39c12', deals: '3.2K+' },
  { name: 'Climate Tech', icon: Leaf, emoji: '🌱', color: '#27ae60', deals: '1.5K+' },
  { name: 'AI/ML', icon: Brain, emoji: '🤖', color: '#9b59b6', deals: '4.1K+' },
  { name: 'Consumer', icon: ShoppingBag, emoji: '🛍️', color: '#e91e63', deals: '2.8K+' },
  { name: 'Industrial', icon: Cog, emoji: '⚙️', color: '#607d8b', deals: '1.2K+' },
  { name: 'Cybersecurity', icon: Shield, emoji: '🔐', color: '#ff5722', deals: '1.9K+' },
  { name: 'Web3', icon: Globe, emoji: '🌐', color: '#795548', deals: '2.3K+' },
  { name: 'Edtech', icon: Zap, emoji: '📚', color: '#ff9800', deals: '1.7K+' },
  { name: 'Biotech', icon: Database, emoji: '🧬', color: '#4caf50', deals: '1.4K+' },
  { name: 'Mobility', icon: Smartphone, emoji: '🚗', color: '#2196f3', deals: '1.6K+' }
 ]
   ...
   <div className="container mx-auto px-6 relative z-10">
    ...
    <div className="text-center mb-16 space-y-4">
     <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full premium-glass border border-[#a98b5d]/20">
      <span className="text-sm font-medium text-[#a98b5d]">INDUSTRY VERTICALS</span>
     </div>
     <h2 className="text-4xl md:text-5xl font-light text-[#dcd7ce]">
      <span className="text-[#a98b5d] font-medium">Specialized Networks</span> Across Sectors
     </h2>
    ...
    <div className="text-center mt-16">
     ...
     <p className="text-[#5c5d63] mb-6 max-w-2xl mx-auto">
      We're constantly expanding our network. Join our waitlist to be notified when your industry vertical launches.
     </p>
