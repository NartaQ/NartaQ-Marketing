...
export default function AboutSection({ className }: AboutSectionProps) {
  ...
  const stickyText = {
    title: 'Who We Are',
    subtitle: 'Connect startups with perfect investors',
    description:
  ...
  const scrollingContent = [
    {
      ...
      description:
        "Nartaq's advanced AI algorithms analyze startup profiles, business models, and growth potential to spot the most compatible investors based on industry focus, investment stage, and strategic alignment.",
      features: [
    ...
    },
    {
      ...
      description:
        'Nartaq creates comprehensive profiles for each startup. We highlight their unique value proposition, market opportunity, team expertise, and funding requirements to attract the right investors.',
      features: [
        'Business Analysis',
        'Market Research',
        'Team Assessment',
    ...
    },
    {
      ...
      description:
        "Access Nartaq's curated network of verified investors. From angel investors to venture capital firms, each has detailed profiles showing their investment preferences and portfolio companies.",
      features: [
    ...
    },
    {
      ...
      description:
        "Nartaq's dedicated customer service team provides personalized guidance throughout the matching process. We offer strategic advice and help build meaningful connections.",
      features: [
    ...
    },
    {
      ...
      description:
        'Nartaq helps both startups and investors with due diligence processes. We provide comprehensive documentation, financial analysis, and market validation to ensure informed decisions.',
      features: [
    ...
    },
    {
      ...
      description:
        "Nartaq's platform streamlines the investment process with secure communication channels, document sharing, and negotiation support to close deals efficiently.",
      features: [
    ...
    },
    {
      ...
      description:
        'Nartaq tracks the success of our matches through ongoing monitoring of funded startups. We measure growth metrics and investor satisfaction to improve our matching algorithm.',
      features: [
        'Growth Tracking',
        'Success Metrics',
        'Investor Feedback',
    ...
    },
    {
      ...
      description:
        'Beyond the initial match, Nartaq maintains relationships with both startups and investors. We provide continued support for future funding rounds and strategic partnerships.',
      features: [
