 ...
 const resources = [
  {
   ...
   description: 'Proven email templates and strategies used by successful founders to connect with investors.',
  ...
  },
  {
   ...
   description: 'Live session with top climate VCs sharing what they look for in early-stage investments.',
   category: 'Pitch Deck',
   duration: '45 min',
   attendees: '2.1K',
   badge: 'Live',
  ...
  },
  {
   ...
   description: 'Calculate your potential revenue and ROI when working with funded startups through our platform.',
  ...
  },
  {
   ...
   description: 'Comprehensive analysis of funding trends, sector performance, and investor preferences.',
  ...
  },
  {
   ...
   description: 'Weekly interviews with successful founders sharing their fundraising journey and lessons learned.',
  ...
  },
  {
   ...
   description: 'Complete checklist covering technical, financial, and market due diligence for early-stage investments.',
   category: 'Investment',
   items: '127 items',
   downloads: '3.8K',
   badge: 'Essential',
   ...
   <div className="container mx-auto px-6 relative z-10">
    ...
    <div className="text-center mb-16 space-y-4">
     <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full premium-glass border border-[#a98b5d]/20">
      <span className="text-sm font-medium text-[#a98b5d]">RESOURCE HUB</span>
     </div>
     <h2 className="text-4xl md:text-5xl font-light text-[#dcd7ce]">
      <span className="text-[#a98b5d] font-medium">Knowledge Center</span> for Growth
     </h2>
    ...
    <div className="flex flex-wrap justify-center gap-3 mb-12">
     {categories.map((category, index) => (
      <button
       key={index}
       className={`category-filter px-6 py-3 rounded-xl font-medium transition-all duration-300 ${category.active
    ...
    <div className="premium-glass rounded-3xl p-8 border border-[#a98b5d]/20 max-w-2xl mx-auto text-center">
     ...
     <p className="text-[#5c5d63] mb-6">
      Get weekly insights, new tools, and exclusive content delivered to your inbox
     </p>
