import { Target, Users, CheckCircle, CreditCard, ArrowRight } from 'lucide-react'
...
export default function OrchestrationSection() {
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'creditcard': return <CreditCard className="w-8 h-8 text-[#a98b5d]" />
      default: return <Target className="w-8 h-8 text-[#a98b5d]" />
    }
  };

  return (
    <section id='orchestration' className='flex w-full flex-col items-center justify-center p-[2%] py-32 relative'>
      ...
      <div className='max-w-6xl mx-auto text-center space-y-8 relative z-10 reveal-up'>
        ...
        <div className="space-y-6">
          ...
          <h2 className='text-4xl md:text-5xl font-light text-[#dcd7ce] '>
            From <span className="font-medium text-[#a98b5d] ">term sheet</span> to delivery
            <br />
            <span className="text-3xl md:text-4xl opacity-80">sophisticated orchestration</span>
          </h2>
          ...
          <p className='text-xl text-[#dcd7ce] font-light leading-relaxed max-w-4xl mx-auto'>
            Transform funding intent into shipped outcomes with our premium orchestration platform.
            <br /><br />
            <span className="text-[#a98b5d]/90">
              Define scopes and milestones, assign vetted service providers, and release escrow‑style payouts 
              on acceptance. Full support for hybrid compensation with standardized legal templates.
            </span>
          </p>
        </div>
      </div>
      ...
      <div className='mt-20 max-w-7xl w-full px-4 reveal-up'>
        ...
        <div className="premium-glass rounded-3xl p-8 md:p-12 border border-[#a98b5d]/20 max-w-4xl mx-auto ">
          <div className="text-center space-y-6">
            <h3 className="text-2xl md:text-3xl font-light text-[#dcd7ce]">
              <span className="font-medium text-[#a98b5d]">Hybrid compensation</span> supported
            </h3>
            
            <p className="text-lg text-[#dcd7ce] font-light leading-relaxed">
              Cash + equity/options arrangements with standardized legal templates via our trusted partner network. 
              All structures are NDA-protected and jurisdiction-compliant.
            </p>
