...
export default function BackendDeveloperApplyPage() {
        ...
        <div className='max-w-2xl mx-auto px-4 text-center'>
          <div className='bg-gradient-to-br from-[#a98b5d]/5 to-transparent border border-[#a98b5d]/20 rounded-2xl p-12 backdrop-blur-sm'>
            ...
            <p className='text-gray-300 mb-8'>
              Thank you for applying for the Backend Developer position. We'll
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                Join our team as a Backend Developer and help build robust APIs
                and services for our investment platform.
              </p>
            </div>
