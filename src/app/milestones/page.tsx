...
const milestones: Milestone[] = [
  {
    ...
    description: 'Building the core platform infrastructure and founding cohort recruitment',
    status: 'in-progress',
    icon: Rocket,
    features: [
      'Multi-step application system for founders, investors, and team members',
      'AI-powered profile analysis and matching algorithms',
      'Email notification system with SendGrid integration',
      'User authentication and authorization framework',
      'Founding cohort recruitment and onboarding',
  ...
  },
  {
    ...
    description: 'Scale pilot program based on early feedback and prepare for blockchain integration',
    status: 'upcoming',
    icon: Clock,
    features: [
      'Enhanced AI matching algorithms based on pilot data',
  ...
  {
    title: 'Blockchain Integration Development',
    date: 'March - April 2026',
    description: 'Implement proprietary DAO infrastructure for startup governance',
    status: 'upcoming',
    icon: Shield,
    features: [
      'Enterprise-grade blockchain infrastructure',
      'Individual DAO creation for each startup',
      'Governance token system (tokenized equity)',
      'Smart contract framework for cap table management',
      'Blockchain-based voting and decision-making',
  ...
  },
  {
    ...
    date: 'May - June 2026',
    description: 'Open platform to broader audience with full blockchain features',
    status: 'upcoming',
    icon: CheckCircle2,
    features: [
      'Full public access with tiered membership',
      'Complete DAO governance for all startups',
      'Secondary market for governance tokens',
      'Institutional investor tools and compliance',
  ...
  },
  {
    ...
    features: [
      ...
      'Regional partnerships with accelerators and VCs',
      'Local payment method integrations',
      'Market-specific matching algorithms',
