          ...
          >
            <div className="space-y-16">
              <section id="intro" className="scroll-mt-32">
                <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-xl p-6 mb-8">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-4">
                    This Privacy Notice for NartaQ SA (doing business as NartaQ) ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
                  </p>
                  <ul className="space-y-2 text-gray-300 mb-4">
                    <li>• Visit our website at http://www.nartaq.com or any website of ours that links to this Privacy Notice</li>
                    <li>• Use NartaQ. NartaQ is a protocol that uses AI for high-signal matching and provides the legal tools for seamless execution. Smarter Matching: Our AI analyzes founder and investor DNA to facilitate perfect, double-opt-in introductions. Guided Execution: We provide the automated legal framework and tools to turn a handshake into a closed deal, without the "I don't know what's next."</li>
                  ...
                  <p className="text-sm text-gray-400">
                    ...
                    <a href="mailto:privacy@nartaq.com" className="text-[#a98b5d] hover:underline">
                      privacy@nartaq.com
                    </a>.
                  </p>
                </div>
              ...
              <section id="summary" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6 space-y-4">
                  ...
                  <div className="space-y-3 text-sm text-gray-300">
                    <p>
                      <strong className="text-[#a98b5d]">What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about personal information you disclose to us.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">Do we process any sensitive personal information?</strong> Some of the information may be considered "special" or "sensitive" in certain jurisdictions, for example your racial or ethnic origins, sexual orientation, and religious beliefs. We do not process sensitive personal information.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">Do we collect any information from third parties?</strong> We do not collect any information from third parties.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Learn more about how we process your information.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">In what situations and with which types of parties do we share personal information?</strong> We may share information in specific situations and with specific categories of third parties. Learn more about when and with whom we share your personal information.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">How do we keep your information safe?</strong> We have adequate organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about how we keep your information safe.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about your privacy rights.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">How do you exercise your rights?</strong> The easiest way to exercise your rights is by visiting <a href="http://www.nartaq.com/data-request" className="text-[#dcd7ce] hover:underline">http://www.nartaq.com/data-request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
                    </p>

                    <p>
                      <strong className="text-[#a98b5d]">Want to learn more about what we do with any information we collect?</strong> Review the Privacy Notice in full.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section id="information-collect" className="scroll-mt-32">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                      Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: <a href="http://www.nartaq.com/legal/cookies" className="text-[#a98b5d] hover:underline">http://www.nartaq.com/legal/cookies</a>.
                    </p>
              ...
              <section id="process-information" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  <p className="text-sm text-gray-400 mb-4">
                    <em>In Short:</em> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent.
                  </p>
              ...
              <section id="legal-bases" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  <p className="text-sm text-gray-400 mb-4">
                    <em>In Short:</em> We only process your personal information when we believe it is necessary and we have a valid legal reason (i.e., legal basis) to do so under applicable law, like with your consent, to comply with laws, to provide you with services to enter into or fulfill our contractual obligations, to protect your rights, or to fulfill our legitimate business interests.
                  </p>
                  ...
                  <div className="space-y-4 text-gray-300 text-sm">
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Consent.</h4>
                      <p>We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. Learn more about withdrawing your consent.</p>
                    </div>
                    
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Performance of a Contract.</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Legitimate Interests.</h4>
                      <p>We may process your information when we believe it is reasonably necessary to achieve our legitimate business interests and those interests do not outweigh your interests and fundamental rights and freedoms. For example, we may process your personal information for some of the purposes described in order to:</p>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Legal Obligations.</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Vital Interests.</h4>
              ...
              <section id="share-information" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  <p className="text-sm text-gray-400 mb-4">
                    <em>In Short:</em> We may share information in specific situations described in this section and/or with the following categories of third parties.
                  </p>
                  
                  <div className="space-y-4 text-gray-300 text-sm">
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Vendors, Consultants, and Other Third-Party Service Providers.</h4>
                      <p className="mb-2">We may share your data with third-party vendors, service providers, contractors, or agents ("third parties") who perform services for us or on our behalf and require access to such information to do that work. We have contracts in place with our third parties, which are designed to help safeguard your personal information. This means that they cannot do anything with your personal information unless we have instructed them to do it. They will also not share your personal information with any organization apart from us. They also commit to protect the data they hold on our behalf and to retain it for the period we instruct.</p>
                      
                      <p className="mb-2">The categories of third parties we may share personal information with are as follows:</p>
                    ...
                    <div>
                      <p className="mb-2">We also may need to share your personal information in the following situations:</p>
                      <ul className="space-y-2">
                        <li><strong className="text-[#a98b5d]">Business Transfers.</strong> We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.</li>
                        <li><strong className="text-[#a98b5d]">Business Partners.</strong> We may share your information with our business partners to offer you certain products, services, or promotions.</li>
                        <li><strong className="text-[#a98b5d]">Other Users.</strong> When you share personal information (for example, by posting comments, contributions, or other content to the Services) or otherwise interact with public areas of the Services, such personal information may be viewed by all users and may be publicly made available outside the Services in perpetuity. Similarly, other users will be able to view descriptions of your activity, communicate with you within our Services, and view your profile.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <section id="cookies-tracking" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-sm">
                    ...
                    <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://www.nartaq.com/legal/cookies" className="text-[#a98b5d] hover:underline">http://www.nartaq.com/legal/cookies</a>.</p>
                    
                    <div className="mt-4">
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Google Analytics</h4>
                      <p>We may share your information with Google Analytics to track and analyze the use of the Services. The Google Analytics Advertising Features that we may use include: Google Analytics Demographics and Interests Reporting. To opt out of being tracked by Google Analytics across the Services, visit <a href="https://tools.google.com/dlpage/gaoptout" className="text-[#a98b5d] hover:underline">https://tools.google.com/dlpage/gaoptout</a>. You can opt out of Google Analytics Advertising Features through Ads Settings and Ad Settings for mobile apps. Other opt out means include <a href="http://optout.networkadvertising.org/" className="text-[#a98b5d] hover:underline">http://optout.networkadvertising.org/</a> and <a href="http://www.networkadvertising.org/mobile-choice" className="text-[#a98b5d] hover:underline">http://www.networkadvertising.org/mobile-choice</a>. For more information on the privacy practices of Google, please visit the Google Privacy & Terms page.</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section id="ai-products" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Use of AI Technologies</h4>
                      <p>We provide the AI Products through third-party service providers ("AI Service Providers"), including Microsoft Azure AI. As outlined in this Privacy Notice, your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.</p>
                    </div>
                    
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">Our AI Products</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#a98b5d] mb-2">How We Process Your Data Using AI</h4>
              ...
              <section id="minors" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  ...
                  <div className="space-y-4 text-gray-300 text-sm">
                    <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:riadh@nartaq.com" className="text-[#a98b5d] hover:underline">riadh@nartaq.com</a>.</p>
                  </div>
                </div>
              </section>
              ...
              <section id="privacy-rights" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  <p className="text-sm text-gray-400 mb-4">
                    <em>In Short:</em> In some regions, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.
                  </p>
                  ...
                  <div className="space-y-4 text-gray-300 text-sm">
                    ...
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-semibold text-[#a98b5d] mb-1">Withdrawing your consent:</h4>
                      ...
                      <div>
                        <h4 className="font-semibold text-[#a98b5d] mb-1">Opting out of marketing and promotional communications:</h4>
                      ...
                      <div>
                        <h4 className="font-semibold text-[#a98b5d] mb-1">Cookies and similar technologies:</h4>
                        <p>Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://www.nartaq.com/legal/cookies" className="text-[#a98b5d] hover:underline">http://www.nartaq.com/legal/cookies</a>.</p>
                      </div>
                    </div>
                    
                    <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:privacy@nartaq.com" className="text-[#a98b5d] hover:underline">privacy@nartaq.com</a>.</p>
                  </div>
                </div>
              </section>
              ...
              <section id="contact" className="scroll-mt-32">
                ...
                <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                  <div className="space-y-4 text-gray-300 text-sm">
                    <p>If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) by email at <a href="mailto:riadh@nartaq.com" className="text-[#a98b5d] hover:underline">riadh@nartaq.com</a>, by phone at +33.784616068, or contact us by post at:</p>
                    
                    <div className="bg-[#0a0a0a]/50 border border-[#a98b5d]/10 rounded-lg p-4">
                      <p className="font-semibold text-[#a98b5d] mb-2">NartaQ SA</p>
                    ...
                    <p>If you are a resident in the European Economic Area, we are the "data controller" of your personal information. We have appointed Riadh Jouini to be our representative in the EEA. You can contact them directly regarding our processing of your information, by email at <a href="mailto:riadh@nartaq.com" className="text-[#a98b5d] hover:underline">riadh@nartaq.com</a>, by visiting <a href="http://www.nartaq.com" className="text-[#a98b5d] hover:underline">http://www.nartaq.com</a>, by phone at +33.784616068, or by post to:</p>
              ...
              <div className="mt-16 pt-8 border-t border-[#a98b5d]/20">
                <div className="bg-gradient-to-r from-gray-800/20 to-gray-700/20 border border-gray-600/20 rounded-xl p-6">
                  <p className="text-sm text-gray-400 leading-relaxed mb-4">
                    <strong className="text-gray-300">Effective Date:</strong> This Privacy Policy was last updated on August 24, 2025, and governs the collection and processing of personal information in connection with NartaQ's AI-powered protocol for startup funding.
                  </p>
                  <div className="flex flex-wrap gap-4 text-xs text-gray-500">
                    <Link href="/legal/terms" className="text-[#a98b5d] hover:text-[#dcd7ce] transition-colors">
                      Terms of Service
                    </Link>
