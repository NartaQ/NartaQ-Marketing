      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="flex flex-col lg:flex-row gap-12">
            <aside className="lg:w-80 lg:sticky lg:top-32 lg:self-start">
            ...
            <main className="flex-1 max-w-none prose prose-invert prose-lg">
              <div className="space-y-16">
                <section id="intro" className="scroll-mt-32">
                  <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-xl p-6 mb-8">
                    ...
                    <ul className="space-y-2 text-gray-300 mb-4">
                      <li>
                        • Visit our website at https://www.nartaq.com or any
                      ...
                      <li>
                        ...
                        double-opt-in introductions. Guided Execution: We
                        provide the automated legal framework and tools to turn
                        a handshake into a closed deal, without the "I don't
                        know what's next."
                      </li>
                      <li>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      help you understand your privacy rights and choices. We
                      are responsible for making decisions about how your
                      personal information is processed. If you do not agree
                ...
                <section id="summary" className="scroll-mt-32">
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6 space-y-4">
                    ...
                    <div className="space-y-3 text-sm text-gray-300">
                      ...
                      <p>
                        <strong className="text-[#a98b5d]">
                          In what situations and with which types of parties do
                      ...
                      <p>
                        ...
                        >
                          https://www.nartaq.com/data-request
                        </Link>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                      ...
                      <p className="text-gray-300 mb-4">
                        ...
                        through cookies and similar technologies. You can find
                        out more about this in our Cookie Notice:{" "}
                        <Link
                          title='View Cookie Notice'
                          href="https://www.nartaq.com/legal/cookies"
                          className="text-[#a98b5d] hover:underline"
                        >
                          https://www.nartaq.com/legal/cookies
                        </Link>
                        .
                      </p>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-gray-300 text-sm">
                            ...
                            on how you interact with us, this log data may
                            include your IP address, device information, browser
                            type, and settings and information about your
                            activity in the Services (such as the date/time
                            stamps associated with your usage, pages and files
                            viewed, searches, and other actions you take such as
                            which features you use), device event information
                        ...
                        <div>
                          ...
                          <p className="text-gray-300 text-sm">
                            ...
                            used, this device data may include information such
                            ...
                            provider and/or mobile carrier, operating system,
                        ...
                        <div>
                          ...
                          <p className="text-gray-300 text-sm">
                            ...
                            your device's location, which can be either precise
                            or imprecise. How much information we collect
                            depends on the type and settings of the device you
                            use to access the Services. For example, we may use
                            GPS and other technologies to collect geolocation
                            data that tells us your current location (based on
                            your IP address). You can opt out of allowing us to
                            collect this information either by refusing access
                            to the information or by disabling your Location
                            setting on your device. However, if you choose to
                            opt out, you may not be able to use certain aspects
                            of the Services.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    ...
                    <ul className="space-y-2 text-gray-300 text-sm">
                      ...
                      <li>
                        ...
                        your information if you choose to use any of our
                      ...
                      <li>
                        ...
                        promotional campaigns. We may process your information
                ...
                <section id="legal-bases" className="scroll-mt-32">
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    ...
                    <div className="space-y-4 text-gray-300 text-sm">
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          believe it is necessary to fulfill our contractual
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          business interests and those interests do not outweigh
                          your interests and fundamental rights and freedoms.
                          For example, we may process your personal information
                    ...
                    <p className="text-gray-300 text-sm mt-4">
                      ...
                      determine the means and/or purposes of the data processing
                      we perform. This Privacy Notice does not apply to the
                      ...
                      into a data processing agreement is the "data controller"
                      responsible for your personal information, and we merely
                      process your information on their behalf in accordance
                    ...
                    <div className="space-y-4 text-gray-300 text-sm">
                      <div>
                        ...
                        <p className="mb-2">
                          ...
                          service providers, contractors, or agents ("third
                          parties") who perform services for us or on our behalf
                          and require access to such information to do that
                          work. We have contracts in place with our third
                          parties, which are designed to help safeguard your
                          ...
                          your personal information with any organization apart
                          from us. They also commit to protect the data they
                          hold on our behalf and to retain it for the period we
                          instruct.
                        </p>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          ...
                          <li>
                            ...
                            the Services) or otherwise interact with public
                            areas of the Services, such personal information may
                            be viewed by all users and may be publicly made
                            available outside the Services in perpetuity.
                    ...
                    <div className="space-y-4 text-gray-300 text-sm">
                      ...
                      <div className="mt-4">
                        ...
                        <p>
                          ...
                          Reporting. To opt out of being tracked by Google
                          ...
                          Features through Ads Settings and Ad Settings for
                          mobile apps. Other opt out means include{" "}
                          <Link
                            title='Opt Out of Network Advertising'
                          ...
                          and{" "}
                          <Link
                            title='Opt Out of Mobile Advertising'
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    ...
                    <div className="space-y-4 text-gray-300 text-sm">
                      <p>
                        ...
                        The terms in this Privacy Notice govern your use of the
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          Microsoft Azure AI. As outlined in this Privacy
                          Notice, your input, output, and personal information
                          will be shared with and processed by these AI Service
                          Providers to enable your use of our AI Products for
                          purposes outlined in "WHAT LEGAL BASES DO WE RELY ON
                          TO PROCESS YOUR PERSONAL INFORMATION?" You must not
                          use the AI Products in any way that violates the terms
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          Products is handled in line with our Privacy Notice
                          and our agreement with third parties. This ensures
                          high security and safeguards your personal information
                          throughout the process, giving you peace of mind about
                          your data's safety.
                        </p>
                      </div>
                    </div>
                ...
                <section id="minors" className="scroll-mt-32">
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    <p className="text-sm text-gray-400 mb-4">
                      <em>In Short:</em> We do not knowingly collect data from
                ...
                <section id="privacy-rights" className="scroll-mt-32">
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    <p className="text-sm text-gray-400 mb-4">
                      ...
                      account at any time, depending on your country, province,
                    ...
                    <div className="space-y-4 text-gray-300 text-sm">
                      <p>
                        ...
                        decision-making. In certain circumstances, you may also
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            NOTICE?" below. You will then be removed from the
                            marketing lists. However, we may still communicate
                            with you — for example, to send you service-related
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            services of our Services. For further information,
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    <div className="space-y-4 text-gray-300 text-sm">
                      ...
                      <p>
                        ...
                        We have appointed Riadh Jouini to be our representative
                        in the EEA. You can contact them directly regarding our
                  ...
                  <div className="bg-[#1a1a1a]/50 border border-[#a98b5d]/20 rounded-xl p-6">
                    <div className="space-y-4 text-gray-300 text-sm">
                      <p>
                        ...
                        contact us at{" "}
                        <a
                          href="mailto:privacy@nartaq.com?subject=Data%20Request"
                          className="text-[#a98b5d] hover:underline"
                        >
                          privacy@nartaq.com
                        </a>
