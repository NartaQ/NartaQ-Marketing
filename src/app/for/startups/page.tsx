        ...
        <section className='relative flex w-full flex-col items-center justify-center p-[2%] py-20 text-center overflow-hidden'>
          ...
          <div className='relative z-10 max-w-4xl space-y-8'>
            ...
            <p className='text-xl md:text-2xl text-neutral-300 max-w-3xl mx-auto reveal-up'>
              Skip the 18-month fundraising cycle and months of hiring. Connect with pre-qualified investors and hire unicorn-level talent who built Google, Stripe, and Airbnb.
            </p>
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-neutral-300 max-w-3xl mx-auto reveal-up'>
                The talent that built Google, Stripe, Airbnb now builds for you. Your startup accelerator without the equity dilution.
              </p>
            </div>
                ...
                >
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <h3 className='text-3xl font-bold text-[#a98b5d]'>FUNDING PATHWAY</h3>
                    </div>
                    <p className='text-lg text-neutral-300 leading-relaxed'>
                      Connect with pre-qualified investors who invest in your stage and sector. Skip cold outreach and get warm introductions to the right VCs.
                    </p>
                    <ul className='space-y-4'>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>AI-powered investor matching based on your startup DNA</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Pitch deck optimization and investor readiness assessment</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Fast-track to Series A/B with proven investor relationships</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Access to angel networks and strategic investors</span>
                      </li>
                    </ul>
                    <div className='pt-4'>
                      <a
                ...
                >
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <h3 className='text-3xl font-bold text-[#dcd7ce]'>ELITE SERVICE PROVIDERS</h3>
                    </div>
                    <p className='text-lg text-neutral-300 leading-relaxed'>
                      Hire unicorn-level talent who built billion-dollar companies. Technical co-founders and CTOs from FAANG companies at equity-friendly rates.
                    </p>
                    <ul className='space-y-4'>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Growth hackers who scaled startups to IPO</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Designers who created award-winning products</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Legal, marketing, and business development experts</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Equity-friendly compensation models for cash-strapped startups</span>
                      </li>
                    </ul>
                    <div className='pt-4'>
                      <a
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Investor-Ready Pitch Deck</h3>
                    <p className='text-neutral-300'>
                      Transform your pitch into a funding magnet. Our experts help you craft compelling narratives that VCs can&apos;t ignore.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🔍</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Due Diligence Preparation</h3>
                    <p className='text-neutral-300'>
                      Get your startup investor-ready with comprehensive due diligence preparation that accelerates funding decisions.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>👥</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Technical Team Building</h3>
                    <p className='text-neutral-300'>
                      Build your dream team with A-players who have scaled companies from zero to billion-dollar valuations.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🚀</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Go-to-Market Strategy</h3>
                    <p className='text-neutral-300'>
                      Execute winning go-to-market strategies with experts who launched products that reached millions of users.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>📈</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Product-Market Fit Acceleration</h3>
                    <p className='text-neutral-300'>
                      Find product-market fit faster with growth experts who understand what makes products stick and scale.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Scaling Infrastructure</h3>
                    <p className='text-neutral-300'>
                      Build scalable infrastructure and operations with engineers who handled billion-user platforms at scale.
                    </p>
                  </div>
                </MagicCard>
              </div>
                ...
                <MagicCard className='p-8'>
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        <h4 className='font-semibold text-[#dcd7ce]'>Alex Smith</h4>
                        <p className='text-sm text-neutral-400'>CEO, TechFlow AI</p>
                      </div>
                    </div>
                    <p className='text-neutral-300 italic'>
                      &ldquo;Raised $5M Series A in 90 days through NartaQ&apos;s investor network. Their pitch deck optimization was game-changing - VCs were fighting to get in.&rdquo;
                    </p>
                  </div>
                </MagicCard>
              </div>
                ...
                <MagicCard className='p-8'>
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        <h4 className='font-semibold text-[#dcd7ce]'>Priya Raj</h4>
                        <p className='text-sm text-neutral-400'>Founder, HealthTech Solutions</p>
                      </div>
                    </div>
                    <p className='text-neutral-300 italic'>
                      &ldquo;Found my technical co-founder through NartaQ - a former Google engineer who built our MVP in 6 weeks. Now we&apos;re scaling to 100K users.&rdquo;
                    </p>
                  </div>
                </MagicCard>
              </div>
                ...
                <MagicCard className='p-8'>
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        <h4 className='font-semibold text-[#dcd7ce]'>Marcus Johnson</h4>
                        <p className='text-sm text-neutral-400'>CEO, FinanceFlow</p>
                      </div>
                    </div>
                    <p className='text-neutral-300 italic'>
                      &ldquo;Hired our entire growth team through NartaQ - all ex-Stripe and Airbnb. Scaled from $100K to $10M ARR in 18 months with their expertise.&rdquo;
                    </p>
                  </div>
                </MagicCard>
              </div>
        ...
        <section className='py-20 bg-gradient-to-b from-black to-[#232428]'>
          <div className='max-w-6xl mx-auto px-6 text-center'>
            ...
            <p className='text-xl text-neutral-300 mb-12 max-w-2xl mx-auto reveal-up'>
              Pay only when you succeed. Equity-friendly rates and deferred compensation options for cash-strapped startups.
            </p>
              ...
              <div className='reveal-scale h-full'>
                <MagicCard className='p-8 h-full flex flex-col'>
                  <div className='flex-1 space-y-6'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#dcd7ce]'>Funding Package</h3>
                    <div className='text-4xl font-bold text-[#a98b5d]'>
                      2-3%
                    </div>
                    <p className='text-neutral-300'>
                      Success fee only on funds raised. No upfront costs, no monthly fees. Pay only when you get funded.
                    </p>
              ...
              <div className='reveal-scale h-full'>
                <MagicCard className='p-8 h-full flex flex-col'>
                  <div className='flex-1 space-y-6'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#dcd7ce]'>Talent Package</h3>
                    <div className='text-4xl font-bold text-[#a98b5d]'>
                      Flexible
                    </div>
                    <p className='text-neutral-300'>
                      Equity-friendly rates or deferred compensation. Hire A-players without burning through your runway.
                    </p>
                    <ul className='space-y-3 text-left flex-1'>
                      <li className='flex items-center space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full'></div>
              ...
              <div className='reveal-scale h-full'>
                <MagicCard className='p-8 border-2 border-[#a98b5d] h-full flex flex-col'>
                  <div className='flex-1 space-y-6'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#dcd7ce]'>All-in-One</h3>
                    <div className='text-4xl font-bold text-[#a98b5d]'>
                      Custom
                    </div>
                    <p className='text-neutral-300'>
                      Combined funding + talent with startup-friendly terms. Your complete growth platform without equity dilution.
                    </p>
                    <ul className='space-y-3 text-left flex-1'>
                      <li className='flex items-center space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full'></div>
        ...
        <section className='py-20 px-6'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-neutral-300 mb-8 max-w-2xl mx-auto reveal-up'>
              Join successful founders who are already scaling faster with our funding and talent platform.
            </p>
