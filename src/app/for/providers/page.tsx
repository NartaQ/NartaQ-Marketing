        ...
        <section className='relative flex w-full flex-col items-center justify-center p-[2%] py-20 text-center overflow-hidden'>
          ...
          <div className='relative z-10 max-w-4xl space-y-8'>
            ...
            <p className='text-xl md:text-2xl text-neutral-300 max-w-3xl mx-auto reveal-up'>
              Elite projects for elite talent. Access exclusive contracts from funded startups and unicorn companies. Your expertise, unicorn-level compensation.
            </p>
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-neutral-300 max-w-3xl mx-auto reveal-up'>
                From FAANG to founding teams. Elite freelancers and service providers working with high-growth startups and unicorn companies.
              </p>
            </div>
                ...
                >
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <h3 className='text-3xl font-bold text-[#a98b5d]'>PREMIUM CLIENT ACCESS</h3>
                    </div>
                    <p className='text-lg text-neutral-300 leading-relaxed'>
                      Work with funded startups and unicorn companies. Access exclusive projects from Series A+ companies with high-value contracts.
                    </p>
                    <ul className='space-y-4'>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>High-value contracts ($50K-$500K+ projects)</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Equity compensation opportunities in promising startups</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Direct access to CTOs, founders, and decision makers</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Skip agency middlemen and keep 100% of your rates</span>
                      </li>
                    </ul>
                  </div>
                </MagicCard>
                ...
                >
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <h3 className='text-3xl font-bold text-[#dcd7ce]'>ELITE EARNING POTENTIAL</h3>
                    </div>
                    <p className='text-lg text-neutral-300 leading-relaxed'>
                      3-5x higher rates than traditional freelancing platforms. Equity upside in high-growth companies with premium project budgets.
                    </p>
                    <ul className='space-y-4'>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Long-term retainer opportunities</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Performance bonuses and success fees</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Premium project budgets ($10K+ minimum)</span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        <div className='w-2 h-2 bg-[#dcd7ce] rounded-full mt-2'></div>
                        <span className='text-neutral-300'>Recurring revenue from growing clients</span>
                      </li>
                    </ul>
                  </div>
                </MagicCard>
        ...
        <section className='py-20 bg-gradient-to-b from-[#232428] to-black'>
          <div className='max-w-6xl mx-auto px-6'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-neutral-300 max-w-3xl mx-auto reveal-up'>
                We work with the top 1% of service providers who have built products for unicorn companies and FAANG organizations.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Senior Software Engineers</h3>
                    <p className='text-neutral-300'>
                      FAANG background with experience building scalable systems. Full-stack, backend, and specialized engineers.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Technical Architects</h3>
                    <p className='text-neutral-300'>
                      CTOs and technical architects who have designed billion-dollar platforms and led engineering teams.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🎨</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Product Designers</h3>
                    <p className='text-neutral-300'>
                      Unicorn company experience creating award-winning products and user experiences that scale.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>📈</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Growth Marketing Experts</h3>
                    <p className='text-neutral-300'>
                      Growth hackers who scaled companies 10x with proven track records in user acquisition and retention.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🤖</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>AI/ML Engineers</h3>
                    <p className='text-neutral-300'>
                      Machine learning experts and AI specialists who built production ML systems at scale.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🔒</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Cybersecurity Specialists</h3>
                    <p className='text-neutral-300'>
                      Security experts who protected billion-dollar platforms and built enterprise-grade security systems.
                    </p>
                  </div>
                </MagicCard>
              </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🎯</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Exclusive Client Vetting</h3>
                    <p className='text-neutral-300'>
                      Only funded and profitable companies. No bidding wars or race-to-the-bottom pricing. Work with serious clients who value expertise.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>🏠</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Flexible Work Arrangements</h3>
                    <p className='text-neutral-300'>
                      Remote-first culture with flexible schedules. Long-term partnership potential with direct founder and CTO relationships.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>📊</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Equity Participation</h3>
                    <p className='text-neutral-300'>
                      Equity participation opportunities in high-growth startups. Share in the upside of the companies you help build.
                    </p>
                  </div>
                </MagicCard>
              </div>
              ...
              <div className='reveal-scale'>
                <MagicCard className='p-8'>
                  <div className='space-y-4'>
                    <div className='text-4xl'>💎</div>
                    <h3 className='text-2xl font-semibold text-[#a98b5d]'>Premium Project Scopes</h3>
                    <p className='text-neutral-300'>
                      Work on cutting-edge projects that matter. Premium budgets for premium work with the latest technologies and methodologies.
                    </p>
                  </div>
                </MagicCard>
              </div>
                ...
                <MagicCard className='p-8'>
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        <h4 className='font-semibold text-[#dcd7ce]'>James Chen</h4>
                        <p className='text-sm text-neutral-400'>Ex-Google Senior Engineer</p>
                      </div>
                    </div>
                    <p className='text-neutral-300 italic'>
                      &ldquo;Tripled my freelance income working with NartaQ clients. These are the projects I dreamed of working on - billion-dollar potential with equity upside.&rdquo;
                    </p>
                  </div>
                </MagicCard>
              </div>
                ...
                <MagicCard className='p-8'>
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        <h4 className='font-semibold text-[#dcd7ce]'>Sarah Park</h4>
                        <p className='text-sm text-neutral-400'>Product Designer, Ex-Airbnb</p>
                      </div>
                    </div>
                    <p className='text-neutral-300 italic'>
                      &ldquo;My equity from one NartaQ client is now worth $2M after their Series B. Finally found clients who understand the value of great design.&rdquo;
                    </p>
                  </div>
                </MagicCard>
              </div>
                ...
                <MagicCard className='p-8'>
                  <div className='space-y-6'>
                    <div className='flex items-center space-x-4'>
                      ...
                      <div>
                        <h4 className='font-semibold text-[#dcd7ce]'>Marcus Rodriguez</h4>
                        <p className='text-sm text-neutral-400'>Growth Marketing, Ex-Stripe</p>
                      </div>
                    </div>
                    <p className='text-neutral-300 italic'>
                      &ldquo;Helped 3 startups reach unicorn status through NartaQ. The quality of clients and projects is unmatched - this is where the best work happens.&rdquo;
                    </p>
                  </div>
                </MagicCard>
              </div>
        ...
        <section className='py-20 px-6'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-neutral-300 mb-12 max-w-2xl mx-auto reveal-up'>
              Keep more of what you earn. Lower fees than other platforms with premium project opportunities.
            </p>
              ...
              <div className='reveal-scale h-full'>
                <MagicCard className='p-8 h-full flex flex-col'>
                  <div className='flex-1 space-y-6'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#dcd7ce]'>Premium Tier</h3>
                    <div className='text-4xl font-bold text-[#a98b5d]'>
                      10% fee
                    </div>
                    <p className='text-neutral-300'>
                      Platform fee vs 20% on other platforms. Access to premium projects and clients.
                    </p>
              ...
              <div className='reveal-scale h-full'>
                <MagicCard className='p-8 border-2 border-[#a98b5d] h-full flex flex-col'>
                  <div className='flex-1 space-y-6'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#dcd7ce]'>Elite Tier</h3>
                    <div className='text-4xl font-bold text-[#a98b5d]'>
                      5% fee
                    </div>
                    <p className='text-neutral-300'>
                      For proven performers with track record. Lowest fees in the industry for elite talent.
                    </p>
                    <ul className='space-y-3 text-left flex-1'>
                      <li className='flex items-center space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full'></div>
              ...
              <div className='reveal-scale h-full'>
                <MagicCard className='p-8 h-full flex flex-col'>
                  <div className='flex-1 space-y-6'>
                    ...
                    <h3 className='text-2xl font-semibold text-[#dcd7ce]'>Equity Projects</h3>
                    <div className='text-4xl font-bold text-[#a98b5d]'>
                      0% fee
                    </div>
                    <p className='text-neutral-300'>
                      Equity participation only. Share in the upside of high-growth startups you help build.
                    </p>
                    <ul className='space-y-3 text-left flex-1'>
                      <li className='flex items-center space-x-3'>
                        <div className='w-2 h-2 bg-[#a98b5d] rounded-full'></div>
        ...
        <section className='py-20 bg-gradient-to-b from-black to-[#232428]'>
          <div className='max-w-4xl mx-auto px-6 text-center'>
            ...
            <p className='text-xl text-neutral-300 mb-8 max-w-2xl mx-auto reveal-up'>
              Join elite service providers who are already earning unicorn-level compensation working on the most exciting projects.
            </p>
