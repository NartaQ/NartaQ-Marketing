      ...
      <div className='pt-32 pb-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <section className='mb-24'>
            ...
            >
              <h2 className='text-4xl font-bold text-[#dcd7ce] mb-8 text-center'>
                Our Vision
              </h2>
              <div className='bg-gradient-to-r from-[#a98b5d]/10 to-[#dcd7ce]/10 border border-[#a98b5d]/20 rounded-2xl p-8'>
                <div className='space-y-6 text-lg text-gray-300 leading-relaxed'>
                  <p>
                    The current venture capital system is fundamentally broken.
                    It prioritizes warm introductions over breakthrough
                    innovations, geographic proximity over global talent, and
                    pedigree over potential. The result? Exceptional founders in
                    emerging ecosystems like Tunisia are systematically excluded
                    from the capital they need to scale.
                  </p>
                  <p>
                    We envision a world where funding decisions are driven by
                    merit, data, and potential impact rather than personal
                    networks and zip codes. Where a brilliant founder in Tunis
                    has the same access to Silicon Valley capital as someone in
                    Palo Alto.
                  </p>
                  <p>
                    NartaQ is building the infrastructure to make this vision
                    reality—starting with the France-Tunisia corridor and
                    expanding globally to democratize access to startup funding.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className='grid md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
              ...
              >
                ...
                <div className='text-gray-400 text-sm space-y-3 mb-6'>
                  <p>
                    <strong className='text-[#dcd7ce]'>Background:</strong>{' '}
                    Serial entrepreneur with deep experience in Franco-Tunisian
                    business ecosystem. Previously founded and scaled multiple
                    ventures across technology and finance sectors.
                  </p>
                  <p>
                    <strong className='text-[#dcd7ce]'>Expertise:</strong>{' '}
                    Business development, regulatory compliance, cross-border
                    operations, and strategic partnerships in France-Tunisia
                    corridor.
                  </p>
                  <p>
                    <strong className='text-[#dcd7ce]'>Vision:</strong> Bridging
                    the gap between exceptional Tunisian talent and global
                    capital markets through systematic, merit-based matching.
                  </p>
                </div>
              ...
              >
                ...
                <div className='text-gray-400 text-sm space-y-3 mb-6'>
                  <p>
                    <strong className='text-[#dcd7ce]'>Background:</strong>{' '}
                    Full-stack developer and security specialist with extensive
                    experience in fintech and blockchain technologies. Expert in
                    building scalable, secure platforms.
                  </p>
                  <p>
                    <strong className='text-[#dcd7ce]'>Expertise:</strong> AI/ML
                    systems, cybersecurity, blockchain development, platform
                    architecture, and automated compliance systems.
                  </p>
                  <p>
                    <strong className='text-[#dcd7ce]'>Vision:</strong> Creating
                    trustworthy, automated infrastructure that enables
                    transparent and secure venture capital processes at global
                    scale.
                  </p>
                </div>
                <div className='flex justify-center gap-4'>
                  ...
                  <a
                    href='https://github.com/bedouijesser'
                    className='text-[#a98b5d] hover:text-[#dcd7ce] transition-colors'
                  >
          ...
          <section id='corridor' className='mb-24'>
            ...
            <div className='grid lg:grid-cols-3 gap-8'>
              ...
              >
                ...
                <p className='text-gray-400 text-sm'>
                  ...
                  compliance, EU-aligned time zones, and growing policy support
                  for tech innovation and cross-border partnerships.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className='text-gray-400 text-sm'>
                  Systematic underinvestment despite exceptional founder quality
                  creates massive opportunities. Growing success stories
                  demonstrate the corridor's potential for 10x returns.
                </p>
              </motion.div>
            </div>
            ...
            >
              <div className='bg-gradient-to-r from-[#a98b5d]/10 to-[#dcd7ce]/10 border border-[#a98b5d]/20 rounded-2xl p-8'>
                <h4 className='text-2xl font-bold text-[#a98b5d] mb-4'>
                  Why Start Here?
                </h4>
