import Curve from '@/components/test/transitionPage'
import {
  Github,
  Globe,
  Heart,
              ...
              >
                ...
                <div className='bg-gradient-to-r from-[#a98b5d]/10 to-[#dcd7ce]/10 border border-[#a98b5d]/20 rounded-2xl p-8'>
                  <div className='space-y-6 text-lg text-gray-300 leading-relaxed'>
                    <p>
                      The current venture capital system is fundamentally
                      broken. It prioritizes warm introductions over
                      breakthrough innovations, geographic proximity over global
                      talent, and pedigree over potential. The result?
                      Exceptional founders in emerging ecosystems like Tunisia
                      are systematically excluded from the capital they need to
                      scale.
                    </p>
                    <p>
            ...
            <section id='team' className='mb-24'>
              ...
              >
                ...
                <p className='text-xl text-gray-400 max-w-2xl mx-auto'>
                  Two founders united by a shared vision of democratizing
                  startup funding
                </p>
              </motion.div>
              ...
              <div className='grid md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
                ...
                >
                  ...
                  <div className='text-gray-400 text-sm space-y-3 mb-6'>
                    <p>
                      ...
                      Serial entrepreneur with deep experience in
                      Franco-Tunisian business ecosystem. Previously founded and
                      scaled multiple ventures across technology and finance
                      sectors.
                    </p>
                    <p>
                    ...
                    <p>
                      <strong className='text-[#dcd7ce]'>Vision:</strong>{' '}
                      Bridging the gap between exceptional Tunisian talent and
                      global capital markets through systematic, merit-based
                      matching.
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className='text-gray-400 text-sm space-y-3 mb-6'>
                    <p>
                      <strong className='text-[#dcd7ce]'>Background:</strong>{' '}
                      Full-stack developer and security specialist with
                      extensive experience in fintech and blockchain
                      technologies. Expert in building scalable, secure
                      platforms.
                    </p>
                    <p>
                      <strong className='text-[#dcd7ce]'>Expertise:</strong>{' '}
                      AI/ML systems, cybersecurity, blockchain development,
                      platform architecture, and automated compliance systems.
                    </p>
                    <p>
                      <strong className='text-[#dcd7ce]'>Vision:</strong>{' '}
                      Creating trustworthy, automated infrastructure that
                      enables transparent and secure venture capital processes
                      at global scale.
                    </p>
                  </div>
                  <div className='flex justify-center gap-4'>
            ...
            >
              <div className='bg-gradient-to-r from-[#a98b5d]/20 to-[#dcd7ce]/20 border border-[#a98b5d]/30 rounded-2xl p-12'>
                ...
                <p className='text-xl text-gray-400 mb-8 max-w-2xl mx-auto'>
                  Be part of building a more equitable future for startup
                  funding. Whether you're a founder, investor, or ecosystem
                  partner, there's a place for you in this revolution.
                </p>
