          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            <div className='text-center'>
              <div className='relative p-8 rounded-2xl border border-[#a98b5d]/20 bg-gradient-to-br from-[#a98b5d]/5 to-transparent hover:border-[#a98b5d]/40 transition-all duration-300 h-full'>
                ...
                <p className='text-[#dcd7ce] leading-relaxed'>
                  Create your profile and we'll personally review it. We're on a
                  mission to build a high-quality community. This human element
                  builds trust.
                </p>
              </div>
            </div>
            ...
            <div className='text-center'>
              <div className='relative p-8 rounded-2xl border border-[#a98b5d]/20 bg-gradient-to-br from-[#a98b5d]/5 to-transparent hover:border-[#a98b5d]/40 transition-all duration-300 h-full'>
                ...
                <p className='text-[#dcd7ce] leading-relaxed'>
                  ...
                  find investors whose thesis matches your business, saving you
            ...
            <div className='text-center'>
              <div className='relative p-8 rounded-2xl border border-[#a98b5d]/20 bg-gradient-to-br from-[#a98b5d]/5 to-transparent hover:border-[#a98b5d]/40 transition-all duration-300 h-full'>
                ...
                <div className='w-12 h-0.5 bg-[#a98b5d] mx-auto mb-4'></div>
                <p className='text-[#dcd7ce] leading-relaxed'>
                  We provide a secure environment for discussion and manage the
                  documentation and fund transfer, making the entire process
                  frictionless.
                </p>
              </div>
            </div>
